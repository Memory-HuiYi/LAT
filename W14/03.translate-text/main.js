...
function processTranslate() {
    ...
    let params = {
        "api-version": "3.0",
        // 語言查詢：https://learn.microsoft.com/zh-tw/azure/cognitive-services/translator/language-support
        "to": "zh-Hant,lzh,yue,en,de,ja,ko,th,vi,fr"
    };
    //取得要翻譯的文字
